...
public class Test {
    public static void main(String[] args) {
        ...
        st1.setstudentId("68122250048");
        System.out.println(st1.getstudentId());

        Student st2 = new Student("68122250048","Kittiwat","Science","Computer Science",1,"0953980822",
        ...
        ClinicStaff cs2 = new ClinicStaff("C002","Kittiwat","Reception",
        "Morning","0953980822","Active","Room101");
        System.out.println(
            cs2.getstaffId() + " " + 
            cs2.getname() + " " + 
            cs2.getposition() + " " + 
